...
class Iface(object):
    def add_player(self, score, uuid, username, profile, channle_name):
        """
        Parameters:
         - score
         - uuid
...
class Client(Iface):
    ...
    def add_player(self, score, uuid, username, profile, channle_name):
        ...
        """
        self.send_add_player(score, uuid, username, profile, channle_name)
        return self.recv_add_player()

    def send_add_player(self, score, uuid, username, profile, channle_name):
        ...
        args.channle_name = channle_name
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.score, args.uuid, args.username, args.profile, args.channle_name)
...
class add_player_args(object):
    ...
    def __init__(self, score=None, uuid=None, username=None, profile=None, channle_name=None,):
        self.score = score
        self.uuid = uuid
        self.username = username
        self.profile = profile
        self.channle_name = channle_name
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.channle_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.profile is not None:
            oprot.writeFieldBegin('profile', TType.STRING, 4)
            oprot.writeString(self.profile.encode('utf-8') if sys.version_info[0] == 2 else self.profile)
            oprot.writeFieldEnd()
        if self.channle_name is not None:
            oprot.writeFieldBegin('channle_name', TType.STRING, 5)
            oprot.writeString(self.channle_name.encode('utf-8') if sys.version_info[0] == 2 else self.channle_name)
            oprot.writeFieldEnd()
...
add_player_args.thrift_spec = (
    ...
    (4, TType.STRING, 'profile', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'channle_name', 'UTF8', None, ),  # 5
)
